...
import com.google.mlkit.vision.QReveIonic.CameraSource;
import com.google.mlkit.vision.QReveIonic.CameraSourcePreview;
import com.google.mlkit.vision.QReveIonic.GraphicOverlay;
import com.google.mlkit.vision.QReveIonic.java.barcodescanner.BarcodeScannerProcessor;
import com.google.mlkit.vision.QReveIonic.java.facedetector.FaceDetectorProcessor;
import com.google.mlkit.vision.QReveIonic.java.facemeshdetector.FaceMeshDetectorProcessor;
import com.google.mlkit.vision.QReveIonic.java.labeldetector.LabelDetectorProcessor;
import com.google.mlkit.vision.QReveIonic.java.objectdetector.ObjectDetectorProcessor;
import com.google.mlkit.vision.QReveIonic.java.posedetector.PoseDetectorProcessor;
import com.google.mlkit.vision.QReveIonic.java.segmenter.SegmenterProcessor;
import com.google.mlkit.vision.QReveIonic.java.textdetector.TextRecognitionProcessor;
import com.google.mlkit.vision.QReveIonic.preference.PreferenceUtils;
import com.google.mlkit.vision.QReveIonic.preference.SettingsActivity;
...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    Constant.leido = false;
    Constant.valor_leido = "";

    Log.i("MIO", "LivePreviewActivity");
    ...
    selectedModel = options.get(0).toString();
    ...
    String camara = sP.getString("camara", "B");
    Log.i("MIO", "pref camara " + camara);
    ...
    Log.i("map values size",String.valueOf(allEntries.size()));
  ...
  public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
    ...
    if (cameraSource != null) {
      if (isChecked) {
        cameraSource.setFacing(CameraSource.CAMERA_FACING_FRONT);
        editor.putString("camara", "F");
        editor.commit();

      } else {
        cameraSource.setFacing(CameraSource.CAMERA_FACING_BACK);
        editor.putString("camara", "B");
        editor.commit();
      }
    }
    preview.stop();
